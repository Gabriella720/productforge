  ...
  return (
    <div className="max-w-6xl mx-auto px-4 pt-32 pb-24">
      ...
      <div className="text-center mb-32 relative">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-brand/5 rounded-full blur-3xl -z-10 animate-pulse duration-[10000ms]"></div>
        ...
        <h1 className="text-7xl md:text-8xl font-black text-text-main mb-8 tracking-tighter animate-in fade-in slide-in-from-bottom-8 duration-700 delay-100">
          {aboutInfo.name}
        </h1>
        
        <p className="text-xl md:text-2xl text-text-muted mb-12 max-w-3xl mx-auto leading-relaxed font-medium animate-in fade-in slide-in-from-bottom-12 duration-700 delay-200">
          {aboutInfo.tagline}
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6 animate-in fade-in slide-in-from-bottom-16 duration-700 delay-300">
          <Link
            to="/projects"
            className="w-full sm:w-auto inline-flex items-center justify-center px-10 py-4 bg-brand text-white rounded-2xl font-bold hover:bg-brand-hover transition-all duration-300 shadow-xl shadow-brand/20 hover:shadow-brand/30 hover:-translate-y-1 active:scale-95"
          >
            {t('home.viewProjects')}
          ...
          <Link
            to="/about"
            className="w-full sm:w-auto inline-flex items-center justify-center px-10 py-4 border-2 border-brand/20 bg-white/50 backdrop-blur-sm text-brand rounded-2xl font-bold hover:bg-brand/5 hover:border-brand/40 transition-all duration-300 hover:-translate-y-1 active:scale-95"
          >
            {t('home.aboutMe')}
          </Link>
        </div>
      ...
      {/* Features Grid */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 animate-in fade-in slide-in-from-bottom-20 duration-1000 delay-500">
        <Card
          icon={Code}
...
const Card = ({ icon: Icon, title, description, link, linkLabel }) => (
  <div className="group p-10 border border-border-soft rounded-[2.5rem] bg-white hover:border-brand/30 transition-all duration-500 hover:shadow-[0_20px_50px_rgba(59,130,246,0.08)] relative overflow-hidden">
